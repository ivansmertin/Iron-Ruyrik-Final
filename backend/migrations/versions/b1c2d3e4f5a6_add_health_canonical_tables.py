...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('metric_type', sa.Enum('weight', 'body_fat_percentage', 'lean_body_mass', 'muscle_mass', 'steps', 'resting_heart_rate', 'heart_rate', 'hrv', 'sleep_duration', 'sleep_score', 'vo2_max', 'workout', name='healthmetrictype', native_enum=False, length=40), nullable=False),
        sa.Column('value', sa.Float(), nullable=False),
        sa.Column('unit', sa.Enum('kg', 'percent', 'bpm', 'ms', 'count', 'minutes', 'seconds', 'ml_kg_min', 'score', name='healthunit', native_enum=False, length=20), nullable=False),
        sa.Column('measured_at', app.db_types.UTCDateTime(), nullable=False),
        sa.Column('source_provider', sa.Enum('manual', 'apple_health', 'health_connect', 'garmin', 'xiaomi', 'withings', 'whoop', 'oura', 'fitbit', 'samsung_health', name='healthsourceprovider', native_enum=False, length=40), nullable=False),
        ...
        sa.Column('import_method', sa.Enum('manual', 'direct_api', 'native_bridge', 'apple_health', 'health_connect', name='healthimportmethod', native_enum=False, length=40), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('user_id', sa.String(length=36), nullable=False),
        sa.Column('provider', sa.Enum('manual', 'apple_health', 'health_connect', 'garmin', 'xiaomi', 'withings', 'whoop', 'oura', 'fitbit', 'samsung_health', name='healthsourceprovider', native_enum=False, length=40), nullable=False),
        sa.Column('status', sa.Enum('disconnected', 'connecting', 'connected', 'syncing', 'error', 'permission_required', 'unsupported', name='healthsyncstatus', native_enum=False, length=40), nullable=False),
